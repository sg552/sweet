...
<div class="box">
    ...
    <p>系统版本：PigCms W_5_0_201306260001_UTF8 <a href="javascript:alert('暂无升级')" class="isub">检查更新</a></p>
    </div>
    <ul class="myinfo">
   <li><p class="red">您的程序版本为：PigCms多用户微信营销系统v1.0</p><span>[ 授权版本：商业版 (终身使用权) ]</span></li>
   <li><p class="red">您的程序版本为：PigCms多用户微信营销系统v1.0</p><span>[ 授权版本：商业版 (终身免费) ]</span></li>
...
<li>如果您购买的是全功能版,PigCms开发出新的模块功能,您会在第一时间得到升级包</li>
	</ul>
    </div>
</div>
