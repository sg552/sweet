...
<head id="Head1">
<title>
	<?php echo C('site_name');?>-PigCms后台管理登录
</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Keywords" content="PigCms微信营销系统" />
<meta name="Description" content="PigCms微信营销系统" />
	...
	<div class="loginBox">
			...
			<div class="content">
            	<form name="form1" method="post" action="<?php echo U('Admin/insert');?>" id="form1" class="myform">
                	...
                	<fieldset>
                		<legend><h1>PigCms 后台管理系统</h1></legend>
...
<div class="footer pt30">
	CopyRight &copy 2013 PigCms All Rights Reserved 版权所有 PigCms<br />
